                    ...
                    <div class="product">
                      ...
                      <div class="infos mainshadow">
                        ...
                        <div class="buy">
                          ...
                          <div class="swap">
                            <a id="ig-product-main-panel-addwishlist" class="button addwishlist hint--top hint--rounded ${autentificacion} ${estar_} ${cssEstar}"  name="${
      game.id
    }"></a>
...
//Función que muestra un mensaje de que no se ha encontrado ningún juego.
